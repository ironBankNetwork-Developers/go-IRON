...
// versions of the go-ethereum implementation. Its goal is to allow iron to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new iron releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular iron release
  struct Version {
