...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "iron.ipc", false, filepath.Join(os.TempDir(), "iron.ipc")},
		{"data", "iron.ipc", false, "data/iron.ipc"},
		{"data", "./iron.ipc", false, "./iron.ipc"},
		{"data", "/iron.ipc", false, "/iron.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "iron.ipc", true, `\\.\pipe\iron.ipc`},
		{"data", "iron.ipc", true, `\\.\pipe\iron.ipc`},
		{"data", `\\.\pipe\iron.ipc`, true, `\\.\pipe\iron.ipc`},
	}
