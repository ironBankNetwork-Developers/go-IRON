...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 16721020172212=ironBank, 16721020172503=ironBanktest)",
...
// for iron and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. iron account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// iron --keystore /tmp/mykeystore --lightkdf account new
//
