...
// Welcome show summary of current iron instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic iron metadata
	fmt.Fprintf(c.printer, "Welcome to the Iron Bank Network (iron) JavaScript console!\n\n")
	c.jsre.Run(`
